  ...
  return (
    <View style={colorScheme === "dark" ? styles.mainDark : styles.main}>
      <View style={styles.head2}>
        ...
        <View style={{ flex: 1, alignItems: "flex-end" }}>
          <MaterialCommunityIcons
            ...
            size={45}
            color={colorScheme === "dark" ? "#BFD1E5" : "#2F2F2F"}
          />
        </View>
      </View>
      ...
      <View style={styles.head}>
        <Pressable
          onPress={today}
          style={[styles.tabs, tab ? styles.true : styles.false]}
        >
          <Text
            style={[
              styles.tabTx,
              tab
                ? [styles.tabTx, { color: "black" }]
                : colorScheme === "dark"
                ? [styles.tabTx, { color: "white" }]
                : [styles.tabTx, { color: "black" }],
            ]}
          >
            TODAY
        ...
        <Pressable
          onPress={calendar}
          style={[styles.tabs, tab ? styles.false : styles.true]}
        >
          <Text
            style={[
              styles.tabTx,
      ...
      {tab ? (
        <ScrollView
          ...
          refreshControl={
            <RefreshControl refreshing={refresh} onRefresh={getTodayData} />
          }
        >
          {loading ? (
            <Loading renk={colorScheme === "dark" ? "white" : "black"} />
          ) : (
            <ScrollView
              style={{ flex: 1 }}
              refreshControl={
              ...
              {veriyok0 ? (
                <View style={{ flex:1, alignItems:"center" , justifyContent:"center" }}>
                  <Text
                    style={[
                      colorScheme === "dark"
                        ? [styles.dataundifindedtx, { color: "#BFD1E5" }]
                        : [styles.dataundifindedtx, { color: "#2F2F2F" }],
                    ]}
                  >
                    Bu güne ait planınız yok
                  </Text>
                </View>
              ) : tofayD.map((value) => {
                return (
                  ...
                  >
                    ...
                    >
                      <View style={styles.datatexView}>
                        <Text style={[styles.dataTex, { color: "#EFBA19" }]}>
                          {value.tarih}
                        </Text>
                        <Text style={[styles.dataTex, { color: "#EFBA19" }]}>
                          {value.baslik}
                      ...
                      <View style={[styles.datatexView]}>
                        <Text style={[styles.dataTex, { color: "#ffede6" }]}>
                          {value.time}
                        </Text>
                        <Text
                          style={[
      ...
      >
        <View style={styles.modalContent}>
          <View style={styles.headModel}>
            ...
            <Text
              style={{ fontWeight: "bold", fontSize: 32, color: "#BFD1E5" }}
            >
              {userName}
            </Text>
          </View>
          ...
          <View style={{ width: "100%", height: "100%", marginTop: "8%" }}>
            ...
            <Pressable onPress={logout} style={styles.pBton}>
